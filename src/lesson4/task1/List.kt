...
fun russian(n: Int): String {
    ...
    var h3: MutableList<String> = mutableListOf("", " одна", " две", " три",
            " четыре", " пять", " шесть",
            " семь", " восемь", " девять")
    val h4: List<String> = listOf(" десять", " одинадцать", " двенадцать", " тринадцать",
            " четырнадцать", " пятнадцать", " шестнадцать",
            " семнадцать", " восемнадцать", " девятнадцать")

    var res = ""

    res += h1[n / 100000 % 10]      //100000

    if ((n / 10000 % 10) == 1) {    //011000
        
        res += h4[n / 1000 % 10]
        
    } else {

        res += h2[n / 10000 % 10]       //010000
        res += h3[n / 1000 % 10]        //001000
