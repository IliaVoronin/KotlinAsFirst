...
var h4 = listOf("", " один", " два", " три",
        " четыре", " пять", " шесть",
        " семь", " восемь", " девять")
val h5 = listOf(" десять", " одинадцать", " двенадцать", " тринадцать",
...
// flag - флажочек, который определяет использовать нам лист с "одна, две" или лист с "один, два"
...
fun russian(n: Int): String {
    ...
    res += toNum(n / 1000, 0) // первая тройка чисел
    ...
    res += toNum(n % 1000, 1) // вторая тройка чисел
